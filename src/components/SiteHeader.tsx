  ...
  return (
    <header className="absolute left-0 top-0 z-50 w-full bg-transparent text-primary-foreground">
      ...
      <Link
        ...
        className="absolute left-[calc(1.5rem+5px)] top-0 z-10 hidden h-[140px] w-[140px] md:block lg:left-[calc(6%+5px)] lg:h-[160px] lg:w-[160px] 2xl:left-[calc(16%+5px)] 2xl:h-[184px] 2xl:w-[184px]"
      >
        <img
          src={logo}
