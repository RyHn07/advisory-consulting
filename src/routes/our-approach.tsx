    ...
    <SiteLayout>
        ...
        <div className="mx-auto max-w-7xl px-6 py-24">
          ...
          <div className="grid gap-6 md:grid-cols-2" data-reveal-children>
            {[
              ...
              {
                t: "Examination-Ready",
                b: "Documentation, testing, and records structured the way examiners actually request them.",
              },
              {
                t: "Continuously Tested",
                b: "Programs are reviewed, retested, and refined as your firm and the rulebook evolve.",
              },
            ].map((p) => (
              <div
                key={p.t}
      ...
      <section data-reveal="fade" style={{ backgroundColor: "#F1EAE3" }}>
        <div className="mx-auto max-w-5xl px-6 py-24 text-center">
          <p
            className="font-serif text-3xl italic leading-snug md:text-4xl"
            style={{ color: "#0D182B" }}
          >
