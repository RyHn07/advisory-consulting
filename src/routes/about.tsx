        ...
        <div className="mx-auto w-full max-w-[1320px] px-6 pt-40 pb-28 md:pt-56 md:pb-36">
          <div className="max-w-3xl animate-fade-up text-left">
            ...
            <p className="mt-8 max-w-2xl section-body-light">
              Advisory Consulting Solutions is supported by a team with decades of experience across
              investment adviser compliance, securities law, regulatory oversight, and financial
              services. Our professionals include attorneys, former regulators, investment adviser
              and broker-dealer compliance specialists, and experienced consultants who bring
              diverse perspectives to complex compliance challenges.
            </p>
          </div>
        </div>
      </section>
      ...
      <section data-reveal="fade" style={{ backgroundColor: "#FAF6F1" }}>
        <div className="mx-auto max-w-7xl px-6 py-24 md:py-32">
          <div className="mb-20">
            ...
            <h2
              className="mt-6 max-w-2xl font-serif text-4xl font-semibold leading-tight md:text-5xl"
              style={{ color: "#0D182B" }}
            >
            ...
            {[
              {
                k: "1",
                t: "Specialized Focus",
                b: "We work exclusively with your team — every policy, control, and review is calibrated to your regulatory reality.",
              },
              {
                k: "2",
                t: "Practical Implementation",
                b: "Programs designed to operate inside your firm's day-to-day workflow, not sit untouched on a shelf.",
              },
              {
                k: "3",
                t: "Defensible Documentation",
